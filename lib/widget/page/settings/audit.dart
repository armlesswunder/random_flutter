...
Widget buildAuditScreen(BuildContext context, StateSetter state) {
        ...
        child: ListView.builder(
            ...
            itemBuilder: (BuildContext context, int index) {
              ...
              try {
                ...
                isCheckedData = bool.parse(tempData[index]['isCheckedData']);
                ...
                list = getFilteredLists()
                    .firstWhere((element) => element.getDisplayData() == list)
                    .trueData;
              } catch (e) {}
              //return Text(
              //  s,
                                          ...
                                          onChanged: (v) {
                                            ...
                                            if (foundIndex != -1) {
                                              ...
                                              var checkFilePath =
                                                  getCheckedFilePath(
                                                      filePath: list);
                                              String str = checkedItems.reduce(
                                                  (value, element) =>
                                                      '$value\n$element');
                                              File(checkFilePath)
                                              ...
                                              var data =
                                                  File(list).readAsLinesSync();
                                              foundIndex = data.indexWhere(
                                                  (element) =>
                                                      DisplayItem(element)
                                                          .getDisplayData() ==
                                                      s);
                                    ...
                                    child: IconButton(
                                      ...
                                      onPressed: () {
                                        if (pos != -1) {
                                          var data =
                                              File(list).readAsLinesSync();
                                          var foundIndex = data.indexWhere(
                                              (element) =>
                                                  DisplayItem(element)
                                                      .getDisplayData()
                                                      .trim() ==
